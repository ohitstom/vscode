...
This can be useful if you want to use syntax highlighters that work with VSCode themes (like Shiki and derivatives), or if your work environment doens't only allows you to install allowlisted extensions.
